					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item active"><a href="#">Tambah Jabatan</a></li>
							</ol>
						</div><!-- /.col -->
					</div><!-- /.row -->
				</div><!-- /.container-fluid -->
				...
				<div class="container-fluid p-4 border">
					...
					<div class="row">
						<div class="col col-lg-8">
							<form action="<?= base_url('jabatan/tambah') ?>" method="post" novalidate>
								<div class="card">
									<div class="card-body">
										<div class="form-group row">
											<label class="col-12 col-lg-3 col-form-label text-lg-right" for="txtNipdn">Nama Jabatan</label>
											<div class="col-12 col-lg-9">
												<input type="text" class="form-control <?= form_error('txtNamaJabatan') ? 'is-invalid' : '' ?>" name="txtNamaJabatan" id="txtNamaJabatan" required value="<?= set_value('txtNamaJabatan') ?>">
